  ...
  return (
    <div className="min-h-screen bg-orange-50 font-sans text-gray-800 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {/* Admin Button Logic */}
              <button
                 onClick={() => { if(isAdmin) setActiveTab('admin'); }}
       ...
       <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'admin' && isAdmin && <AdminPanel user={user} db={db} appId={appId} />}
        {activeTab === 'admin' && !isAdmin && <div className="text-center p-10 text-red-600">Access Denied. Use toggle in footer.</div>}
      </main>
...
function AdminPanel({ user, db, appId }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden min-h-[600px] flex flex-col">
      ...
      <div className="p-6 bg-gray-50 flex-grow">
        {activeAdminTab === 'bookings' ? <AdminBookings user={user} db={db} appId={appId} /> : <AdminEvents user={user} db={db} appId={appId} />}
      </div>
    </div>
  );
}
